            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <h4 class="page-title float-left">Bancas <div>Adicionar banca <a href="{{route('banca.create')}}"><img class="icon-colored" src="{{ asset('public/images/icons/plus.svg') }}" title="ADICIONAR ESPECIALIDADE" style="width:25px;"></a></div>  </h4>
                        ...
                        <div class="col-12">
                           <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{$banca->id}}</th>
                                        <td>{{$banca->banca}}</td>
                                        <td>{{$banca->status}}</td>
                                        <td>
                                        <a href="banca/edit/{{$banca->id}}" class="btn btn-primary">Editar</a>
                                        <a href="banca/destroy/{{$banca->id}}" class="btn btn-danger">Apagar</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
