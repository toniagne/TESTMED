                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            @endif
                            <h4 class="page-title float-left">Prova</h4>
                        ...
                        <div class="card-box">
                                <form method="post" action="{{ route('provas.update', $prova->id) }}">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="nome" value={{ $prova->nome }} />
                                        </div>
                                        <div class="form-group">
                                          <label for="price">Descricao:</label>
                                          <textarea type="text" class="form-control" name="descricao" >{{ $prova->descricao }} </textarea>
                                        </div>
                                        <div class="form-group">
